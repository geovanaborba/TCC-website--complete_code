...
<body>
    ...
    <a href="./alterarDados.php" class="w3-display-topleft"> <i class="fa fa-arrow-circle-left w3-large w3-purple w3-button w3-xxlarge"></i> </a>
    ...
    echo ' 
                           ...
                           <h1 class="w3-center w3-deep-purple w3-round-large w3-margin">Lista de Cadastros - Moderação </h1> 
        ...
        foreach ($resultado as $linha) {
            ...
            echo '<td>
                ...
                '&username=' . $linha['username'] . '&email=' . $linha['email'] . '">
                                                                                                                                                <i class="fa fa-user-times w3-large w3-text-purple"></i> 
                                                                                                                                                </a>
                                                                                                                                                </td>
                                                                                                                                                </td>';
            echo '<td>
                ...
                '&username=' . $linha['username'] . '&email=' . $linha['email'] . '">
                                                                                                                                                <i class="fa fa-refresh w3-large w3-text-purple""></i>
                                                                                                                                                </a>
                                                                                                                                                </td>
                                                                                                                                                </td>';
            echo '</tr>';
